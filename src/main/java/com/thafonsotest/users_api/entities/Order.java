...
public class Order implements Serializable {
    ...
    @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd'T'HH:mm:ss'Z'", timezone = "GMT") // update the Json form for to see the time in the body
    ...
    public void setOrderStatus(OrderStatus orderStatus) {
        if (orderStatus != null) { // If orderStatus is null, it gets the code.
